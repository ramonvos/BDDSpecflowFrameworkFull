...
Scenario: Login scenario of BugZilla
	...
	When I provide the "ramon@bugzilla.com", "221219880" and click on Login button
...
Scenario Outline: Create Bug scenario of Bugzilla with scenario outline
	...
	| A        | File a Bug | Log in to Bugzilla | rahul@bugzilla.com | rathore | Enter Bug: TestProduct | Enter Bug: TestProduct | critical | Macintosh | Other    | Summary - 1 | Desc - 1 |
	| B        | File a Bug | Log in to Bugzilla | rahul@bugzilla.com | rathore | Enter Bug: TestProduct | Enter Bug: TestProduct | major    | Other     | Linux    | Summary - 2 | Desc - 2 |