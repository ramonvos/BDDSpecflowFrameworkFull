...
#line 15
 testRunner.When("I provide the \"ramon@bugzilla.com\", \"221219880\" and click on Login button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 16
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:user", "ramon@bugzilla.com")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pass", "221219880")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:eTitle", "Enter Bug: TestProduct")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:bTitle", "Enter Bug: TestProduct")]
        ...
        {
            this.CreateBugScenarioOfBugzillaWithScenarioOutline("A", "File a Bug", "Log in to Bugzilla", "ramon@bugzilla.com", "221219880", "Enter Bug: TestProduct", "Enter Bug: TestProduct", "critical", "Macintosh", "Other", "Summary - 1", "Desc - 1", ((string[])(null)));
        }
        ...
        {
            this.CreateBugScenarioOfBugzillaWithScenarioOutline("B", "File a Bug", "Log in to Bugzilla", "ramon@bugzilla.com", "221219880", "Enter Bug: TestProduct", "Enter Bug: TestProduct", "major", "Other", "Linux", "Summary - 2", "Desc - 2", ((string[])(null)));
        }
    }
}
